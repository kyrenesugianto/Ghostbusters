...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        # Step 2: Choose an action that brings Pacman closest to the closest ghost
        ...
        for action in legal:
            ...
            closestGhostDistance = min(self.distancer.getDistance(successorPosition, ghostPosition)
